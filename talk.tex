...
\begin{frame}
    \includegraphics[width=1.8cm]{figures/SPbSU_logo_ru.pdf}
    % Если решили делать презентацию на английском, то есть "английская версия" логотипа
    %\includegraphics[width=1.8cm]{figures/SPbSU_logo_en.pdf}
    \vspace{-35pt}
    \hspace{-10pt}
    \begin{center}
        \begin{tabular}{c}
